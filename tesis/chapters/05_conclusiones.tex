...
El alcance del rescate también tiene frontera. Donde el \emph{leverage effect} es débil, el régimen pierde su contenido direccional y el margen de la regla se estrecha hasta anularse. El estudio se ciñe además a un único agente y a una única ventana fuera de muestra, de modo que la generalización a otros agentes, a otros universos y a otros periodos queda por establecer.
