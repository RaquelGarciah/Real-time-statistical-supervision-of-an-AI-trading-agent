...
La sección anterior deja un hecho sin explicar: qué canal rescata cada activo cambia de uno a otro. Primero medimos qué propiedad del activo ordena el rescate del aprendiz, y resulta ser el \emph{leverage effect}. Después un clustering, sin etiquetas, recupera los mismos grupos que esa propiedad dibuja. Sobre diez activos esto es un patrón, no un teorema.
...
El panel cierra la pregunta con la que abrió: lo que en SPY no alcanzaba significancia en solitario la alcanza al agregar. El balance y sus implicaciones quedan para el capítulo de conclusiones.
