...
Un rescate probado necesita sus límites dichos con la misma claridad. Reconocer dónde acaba el alcance no diluye lo demostrado: lo vuelve defendible. Cinco resultados del capítulo viven por debajo del listón de la significancia, y la Tabla~\ref{tab:mp-limites} los reúne con su contraste y su veredicto: la victoria sobre la trivial es nominal, la ley del \emph{leverage} es una tendencia al $\alpha = 0{,}10$, la protección de riesgo de la regla no sobrevive a Bonferroni, la regla se invierte en SPY-bajista (una falsación que pre-registramos y que la agregación del panel resuelve), y el clustering es exploratorio.
...
El panel cierra la pregunta con la que abrió: lo que en SPY no alcanzaba significancia en solitario la alcanza al agregar. El capítulo de conclusiones recoge ese balance, lee sus implicaciones prácticas de despliegue y abre las líneas futuras.
