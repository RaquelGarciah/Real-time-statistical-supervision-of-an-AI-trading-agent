...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.78\textwidth]{figuras/cap4_anexo_ablacion}
\caption{Accuracy del aprendiz con tres conjuntos de características: solo las del agente, solo las de STRATA y las veintidós juntas. Quitar STRATA degrada al modelo, prueba de que se apoya en sus señales.}
\label{fig:anx-ablacion}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.82\textwidth]{figuras/cap4_anexo_shap_cuota}
\caption{Cuota de importancia de las señales de STRATA por activo y caída de accuracy al ablacionarlas. Supera la mitad en los diez activos: el aprendiz redescubre los detectores en todo el panel.}
\label{fig:anx-shap-cuota}
\end{figure}
