...
Para juzgar si una estrategia lo hace bien no basta con mirar cuánto gana: hay que poner el rendimiento en relación con el riesgo asumido. A continuación describiremos unas métricas que enriqueceran nuestros resultados aunque es importante entender que inguna prueba nada por sí sola y la prueba estadística del trabajo descansa en los contrastes de la Sección~\ref{sec:tests}.
...
\subsection{Contrastes de equivalencia}
