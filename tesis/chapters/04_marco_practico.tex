...
Este capítulo responde a la pregunta operativa del trabajo sobre un activo concreto: en un benchmark justo, ¿un meta-learner desplegable que consume las señales de STRATA mejora la dirección del agente y supera a las estrategias triviales? Sobre SMCI la respuesta es sí, aunque solo de forma nominal. M10 gana a todos los baselines y la ventaja resiste a varias particiones; la significancia plena queda como trabajo futuro.
