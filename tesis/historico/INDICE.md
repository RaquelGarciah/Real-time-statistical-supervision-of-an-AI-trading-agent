...
| 2026-06-23 | 17:07 | [`tesis_2026-06-23_1707_marco-practico-v2.pdf`](tesis_2026-06-23_1707_marco-practico-v2.pdf) | Marco práctico v2 (cap. 4) expandido a research note completo: 13 tablas (detectores+atribución, variantes de intervención override/abstención/reduce, McNemar, ablación+SHAP, bull/bear, costes/turnover, silueta, perfiles de cluster). Gates: rigor APROBADO (3 fixes: denominador detectores n=401, PSA 0,5%, rolling 9/10), detector-ia 22% PASS, estilo BLOCK→15 fixes (patrón "no es X", meta-comentarios). Cifras trazadas a JSON; intro de Raquel intacta. 49 págs. **Versión actual.** |
