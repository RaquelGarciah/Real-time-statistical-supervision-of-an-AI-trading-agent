...
| 10 | *"¿Por qué llamarlo STRATA si M10 podría usar cualquier feature set?"* | Porque **M10 es inseparable de STRATA por construcción**: la **ablación** muestra que M10 con solo las 15 features del agente cae a **0,476 ≈ M5** (las 7 señales de STRATA aportan la ventaja), y el **SHAP** (cap. 4) coloca esas 7 señales por delante de las del agente. Sin las señales de STRATA, M10 no aporta nada sobre el agente. |
